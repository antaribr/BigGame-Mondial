...
for (const name of ["index.html", "styles.css", "api/admin.js", "api/config.js", "api/quiz.js", "api/tasks.js", "data/BigGame-Quiz-Import-Template.xlsx", "supabase/schema.sql", "supabase/tasks-migration.sql", "supabase/admin-finishers-migration.sql"]) {
